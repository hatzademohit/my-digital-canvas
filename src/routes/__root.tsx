...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Mohit Hatzade — Frontend Developer (React, Next.js, TypeScript)" },
      { property: "og:description", content: "Frontend Developer with 4+ years of experience building scalable, responsive web apps with React, Next.js & TypeScript. Available for freelance and full-time roles." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Mohit Hatzade — Frontend Developer (React, Next.js, TypeScript)" },
      { name: "twitter:description", content: "Frontend Developer with 4+ years of experience building scalable, responsive web apps with React, Next.js & TypeScript. Available for freelance and full-time roles." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/6407f201-c92c-44ef-84d0-57b6be9264b7" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/6407f201-c92c-44ef-84d0-57b6be9264b7" },
    ],
    links: [
